...
icc -O2 -msse2 -nolib-inline -DUSE_PAUSE test_timer_overhead.c low_overhead_timers_icc.o -qopt-report=5 -o timer_ovhd_external.icc.exe
mv test_timer_overhead.optrpt test_timer_overhead.external.optrpt
icc -O2 -msse2 -nolib-inline -DUSE_PAUSE test_timer_overhead.c -S -o timer_ovhd_external.icc.s

echo "compiling inlined version with icc"
icc -O2 -msse2 -nolib-inline -DUSE_PAUSE -DINLINE_TIMERS test_timer_overhead.c -qopt-report=5 -o timer_ovhd_inline.icc.exe
mv test_timer_overhead.optrpt test_timer_overhead.inline.optrpt
icc -O2 -msse2 -nolib-inline -DUSE_PAUSE -DINLINE_TIMERS test_timer_overhead.c -S -o timer_ovhd_inline.icc.s
...
gcc -O2 -msse2 -fno-tree-loop-distribute-patterns -DUSE_PAUSE test_timer_overhead.c low_overhead_timers_gcc.o -o timer_ovhd_external.gcc.exe
gcc -O2 -msse2 -fno-tree-loop-distribute-patterns -DUSE_PAUSE test_timer_overhead.c -fverbose-asm -S -o timer_ovhd_external.gcc.s

echo "compiling inlined version with gcc"
gcc -O2 -msse2 -fno-tree-loop-distribute-patterns -DUSE_PAUSE -DINLINE_TIMERS test_timer_overhead.c -o timer_ovhd_inline.gcc.exe
gcc -O2 -msse2 -fno-tree-loop-distribute-patterns -DUSE_PAUSE -DINLINE_TIMERS test_timer_overhead.c -fverbose-asm -S -o timer_ovhd_inline.gcc.s
