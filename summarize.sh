...
for COUNTER in multiline_inline_rdtscp rdtsc inline_rdtsc_64 inline_rdtsc_32 rdtscp inline_rdtscp_64 inline_rdtscp_32 full_rdtscp rdpmc_instructions rdpmc_actual_cycles inline_rdpmc_actual_cycles_64 inline_rdpmc_actual_cycles_32 rdpmc inline_rdpmc_programmable_64 inline_rdpmc_programmable_32 rdpmc_reference_cycles inline_rdpmc_reference_cycles_64 inline_rdpmc_reference_cycles_32
do
	echo -n "${COUNTER} "
